...
public class NewMinigameScreen extends PirateScreen {
    ...
    public NewMinigameScreen(GameInstance gameInstance) {
    ...
    private void createMenu() {
        ...
        TextButton easyMinigame = new TextButton("Easy", StyleManager.generateTBStyle(25, Color.GREEN, Color.GRAY));
        ...
        TextButton medMinigame = new TextButton("Medium", StyleManager.generateTBStyle(25, Color.YELLOW, Color.GRAY));
        ...
        TextButton hardMinigame = new TextButton("Hard", StyleManager.generateTBStyle(25, Color.RED, Color.GRAY));
        ...
        TextButton veryHardMinigame = new TextButton("Very Hard", StyleManager.generateTBStyle(25, Color.BLACK, Color.GRAY));
...
enum MinigameDifficulty {
    EASY(FileManager.MINIGAME_ENEMY_EASY_1,FileManager.MINIGAME_ENEMY_EASY_2,2,0.5f),
    MEDIUM(FileManager.MINIGAME_ENEMY_MED_1,FileManager.MINIGAME_ENEMY_MED_2,50,0.3f),
    HARD(FileManager.MINIGAME_ENEMY_HARD_1,FileManager.MINIGAME_ENEMY_HARD_2,200,0.26f),
    VERY_HARD(FileManager.MINIGAME_ENEMY_VHARD_1,FileManager.MINIGAME_ENEMY_VHARD_2,500,0.23f);

    private Texture enemyHolstered, enemyShooting;
    private Integer reward;
    private float countdown;

    MinigameDifficulty(Texture enemyHolstered, Texture enemyShooting, Integer reward, float countdown) {
